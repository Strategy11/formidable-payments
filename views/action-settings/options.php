...
<div class="<?php echo esc_attr( $classes['bank_account'] ); ?>">
	<h3>
		<?php esc_html_e( 'Bank Account Details', 'frmauthnet' ); ?>
	</h3>
</div>
...
<div class="frm_trans_shipping <?php echo $hide_ship = esc_attr( $form_action->post_content['use_shipping'] ? '' : 'frm_hidden' ); ?> <?php echo esc_attr( $classes['use_shipping'] ); ?>">
	<h3>
